...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreBlasting(pWriter, SAPPHIRE_SMELTABLES, RecipeCategory.MISC, ModItems.SAPPHIRE.get(), 5.0f, 100, "sapphire");
        oreSmelting(pWriter, SAPPHIRE_SMELTABLES, RecipeCategory.MISC, ModItems.SAPPHIRE.get(), 5.0f, 200, "sapphire");
        ...
        //there exists a '9 block storage recipe' method from mojang, but it also had a hardcoded namespace to default mc so its a no-go
    ...
    //grabbed 3 methods from RecipeProvider class to modify them such that my mod's namespace goes through.
